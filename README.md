...
|[`FastTIFF-amd64.deb`](https://github.com/konung-yaropolk/FastTIFF/releases/latest/download/FastTIFF-amd64.deb) |<img width="16" height="16" alt="debian" src="https://github.com/user-attachments/assets/2fefe976-d357-4abb-a476-6a8a31b422fe" /> **Debian / <img width="16" height="16" alt="ubuntu" src="https://github.com/user-attachments/assets/e2bd815d-709d-4571-9665-f957c90e8300" /> Ubuntu** — x86-64 | `sudo apt install ./FastTIFF-amd64.deb` |
...
|[`FastTIFF-aarch64.rpm`](https://github.com/konung-yaropolk/FastTIFF/releases/latest/download/FastTIFF-aarch64.rpm) |<img width="16" height="16" alt="fedora" src="https://github.com/user-attachments/assets/97817114-81e7-40bd-8b4d-165fc856cba4" /> **Fedora / <img width="16" height="16" alt="redhat-icon" src="https://github.com/user-attachments/assets/aaf64e10-797c-4cb7-87d9-04293d761cc8" /> RHEL / <img width="16" height="16" alt="suse" src="https://github.com/user-attachments/assets/2f9e5316-fbea-4394-b801-784672831993" /> openSUSE** — ARM64 | `sudo dnf install ./FastTIFF-aarch64.rpm` |
...
|[`FastTIFF-aarch64.flatpak`](https://github.com/konung-yaropolk/FastTIFF/releases/latest/download/FastTIFF-aarch64.flatpak) |<img width="16" height="16" alt="linux-tux" src="https://github.com/user-attachments/assets/78810b28-56ac-4d72-b0b1-ad8a93b9d2a9" /> **Any Linux** · Flatpak — ARM64 | `flatpak install --user ./FastTIFF-aarch64.flatpak` |
