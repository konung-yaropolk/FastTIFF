...
pub use decode::{
    ...
    read_plane_rgb_u16, read_plane_rgb_u8, read_planes_f32_into, read_planes_rgb_u16, read_planes_rgb_u8,
    read_planes_u16, read_planes_u16_into, read_planes_u8, read_planes_u8_into,
    set_parallel_decode,
};
pub use encode::{
...
pub use index::{Compression, FrameInfo, Region, RowBand, SampledBand, SampleFormat, Strips, TiffStack};