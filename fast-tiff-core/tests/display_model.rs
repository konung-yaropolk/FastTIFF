...
//! RGB channel plan were private to it. Both are public `fast-tiff-core` API
...
use fast_tiff_core::dimensions::rgb_channel_plan;
use fast_tiff_core::{DecodeMode, MAX_CHANNELS};
